...
import { useState } from "react";
import CustomButton from "../../utils/CustomButton";
import { useCreateAndUpdateTramsMutation } from "../../redux/features/setting/settingApi";


const EditTermsConditions = () => {
  const [form] = Form.useForm();
  const [content, setContent] = useState("<h1>Enter your 'Terms and Conditions' content here.</h1>"); // Default content for the Terms and Conditions section

  // Initialize the mutation hook
  const [createUpdateTerms, { isLoading, isError, isSuccess }] = useCreateAndUpdateTramsMutation();
